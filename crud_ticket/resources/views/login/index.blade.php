...
@section('container')
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <!-- <div class="card text-center" style="background-color: #9FC9F3;"> -->
                    <main class="form-login">
                    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
